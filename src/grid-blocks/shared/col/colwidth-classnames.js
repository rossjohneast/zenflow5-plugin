const sharedColWidthClassnames = (props) => {
    return (
       [
        ...
        [props.attributes.colWidthSm !== undefined && props.attributes.colWidthSm !== '' ? `col${props.attributes.colWidthSm}` : ''],
        [props.attributes.colWidthMd !== undefined && props.attributes.colWidthMd !== '' ? `col${props.attributes.colWidthMd}` : ''],
        [props.attributes.colWidthLg !== undefined && props.attributes.colWidthLg !== '' ? `col${props.attributes.colWidthLg}` : ''],
        [props.attributes.colWidthXl !== undefined && props.attributes.colWidthXl !== '' ? `col${props.attributes.colWidthXl}` : ''],
        [props.attributes.colWidthXxl !== undefined && props.attributes.colWidthXxl !== '' ? `col${props.attributes.colWidthXxl}` : ''],
